    ...
    def decorator(method):
        ...
        def new_method(self, event):
            if ctrl and not event.state == 4:
                return
            return _coconut_tail_call(method, self, event)
...
# TODO: Move all this code to a method in `fxi`.
    ...
    def handle_commands(self, line):
        (tuple)(map(self.handle_command, re.split(r'; ?', line)))


def handle_command(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    if (_coconut.len(_coconut_match_to_args) == 2) and ("self" not in _coconut_match_to_kwargs) and (_coconut_match_to_args[1] is None):
    ...
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def handle_command(self, None):'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = 'def handle_command(self, None):'
...
def handle_command(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    if (_coconut.len(_coconut_match_to_args) == 2) and ("self" not in _coconut_match_to_kwargs) and (_coconut_match_to_args[1] == ''):
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("self")
        if not _coconut_match_to_kwargs:
            self = _coconut_match_temp_0
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " '"def handle_command(self, \'\'):"' " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = "def handle_command(self, ''):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
# TODO: That's horrible! How can I use @addpattern properly?
    ...
    return _coconut_tail_call(self.do_handle_command, head, parsed_args)


CommandLine.handle_command = handle_command


def do_handle_command(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    if (2 <= _coconut.len(_coconut_match_to_args) <= 3) and ("self" not in _coconut_match_to_kwargs) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 2, "parsed_args" in _coconut_match_to_kwargs)) == 1) and (_coconut_match_to_args[1] == ':q'):
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("self")
        _coconut_match_temp_1 = _coconut_match_to_args[2] if _coconut.len(_coconut_match_to_args) > 2 else _coconut_match_to_kwargs.pop("parsed_args")
        if not _coconut_match_to_kwargs:
            self = _coconut_match_temp_0
            parsed_args = _coconut_match_temp_1
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " '"def do_handle_command(self, \':q\', parsed_args):"' " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = "def do_handle_command(self, ':q', parsed_args):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def do_handle_command(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    if (2 <= _coconut.len(_coconut_match_to_args) <= 3) and ("self" not in _coconut_match_to_kwargs) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 2, "parsed_args" in _coconut_match_to_kwargs)) == 1) and (_coconut_match_to_args[1] == ':r'):
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("self")
        _coconut_match_temp_1 = _coconut_match_to_args[2] if _coconut.len(_coconut_match_to_args) > 2 else _coconut_match_to_kwargs.pop("parsed_args")
        if not _coconut_match_to_kwargs:
            self = _coconut_match_temp_0
            ...
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " '"def do_handle_command(self, \':r\', parsed_args):"' " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = "def do_handle_command(self, ':r', parsed_args):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def do_handle_command(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    if (2 <= _coconut.len(_coconut_match_to_args) <= 3) and ("self" not in _coconut_match_to_kwargs) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 2, "parsed_args" in _coconut_match_to_kwargs)) == 1) and (_coconut_match_to_args[1] == ':c'):
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("self")
        _coconut_match_temp_1 = _coconut_match_to_args[2] if _coconut.len(_coconut_match_to_args) > 2 else _coconut_match_to_kwargs.pop("parsed_args")
        if not _coconut_match_to_kwargs:
            self = _coconut_match_temp_0
            ...
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " '"def do_handle_command(self, \':c\', parsed_args):"' " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = "def do_handle_command(self, ':c', parsed_args):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def do_handle_command(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    if (2 <= _coconut.len(_coconut_match_to_args) <= 3) and ("self" not in _coconut_match_to_kwargs) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 2, "parsed_args" in _coconut_match_to_kwargs)) == 1) and (_coconut_match_to_args[1] == 'echo'):
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("self")
        _coconut_match_temp_1 = _coconut_match_to_args[2] if _coconut.len(_coconut_match_to_args) > 2 else _coconut_match_to_kwargs.pop("parsed_args")
        if not _coconut_match_to_kwargs:
            self = _coconut_match_temp_0
            ...
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " '"def do_handle_command(self, \'echo\', parsed_args):"' " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = "def do_handle_command(self, 'echo', parsed_args):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
