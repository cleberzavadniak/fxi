...
def sanitize_string(s):
    return _coconut_tail_call(re.sub, r'[^a-zA-Z0-9_]', '__', s)
...
class MySlideShow(ImageSlideShow):
    ...
    def create_slide(self, item):
        ...
        slide.text = (sanitize_string)(ptext)
        slide.date = date
        slide.subtitle = (sanitize_string)(username)
        slide.set_image_from_url(img_src)
        self.slides.append(slide)
        slide.render((sanitize_string)(self.title))
